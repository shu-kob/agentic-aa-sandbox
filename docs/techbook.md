...
一方はGPUコンピュートを買いたい**買い手エージェント**。もう一方はそれを提供する**売り手エージェント**です。両者とも、背後にいる人間のオーナーから自律的に行動する権限を委譲されています。
...
従来のWeb2的なアプローチでは、信頼できる第三者（プラットフォーム運営者）が間に立ちます。しかし、自律エージェントの世界では、中央集権的な仲介者なしに取引を成立させる必要があります。
...
この三層構造が、AIエージェントの安全性を段階的に保証します。LLMが騙されてもツールが止め、ツールが迂回されてもコントラクトが止めます。
